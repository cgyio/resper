...
class QRcodeUsage
{
    ...
    public static function createQrCodeImg($msg, $f=FALSE, $e=QR_ECLEVEL_L, $s=6, $m=2, $p=FALSE){
        //文件保存目标位置
        $fp = dirname(__FILE__)."/save";
        if($f!==FALSE){
            $f = $fp."/".(empty($f) ? "" : $f."_").date("YmdHis",time()).".png";
        }
        return QRcode::png($msg,$f,$e,$s,$m,$print);
    }
